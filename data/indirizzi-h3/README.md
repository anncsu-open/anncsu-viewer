...
| `h3_cell` | varchar | Identificativo esadecimale della cella H3 di risoluzione 5 che contiene l'indirizzo. Presente solo nei file partizionati, dove coincide con il nome della directory e del file. |
